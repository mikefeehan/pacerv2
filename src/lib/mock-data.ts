...
export const MOCK_PACER_MEMOS: Record<string, PacerVoiceMemos> = {
  pacer_ashley: {
    ...
    pacerName: 'Ashley',
    memos: [
      { id: 'ashley_1', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_01.ogg', vibeTag: 'cheerful', duration: 5, name: "Let's go, you got this!", createdAt: '2024-01-01' },
      { id: 'ashley_2', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_02.ogg', vibeTag: 'cheerful', duration: 6, name: "You're crushing it!", createdAt: '2024-01-01' },
      { id: 'ashley_3', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_03.ogg', vibeTag: 'cheerful', duration: 4, name: "Turn it up!", createdAt: '2024-01-01' },
      { id: 'ashley_4', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_04.ogg', vibeTag: 'fired_up', duration: 7, name: "THIS is your moment!", createdAt: '2024-01-01' },
      { id: 'ashley_5', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_05.ogg', vibeTag: 'fired_up', duration: 5, name: "No stopping now!", createdAt: '2024-01-01' },
      { id: 'ashley_6', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_06.ogg', vibeTag: 'harsh_coach', duration: 6, name: "Push mode. No excuses.", createdAt: '2024-01-01' },
      { id: 'ashley_7', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_07.ogg', vibeTag: 'harsh_coach', duration: 8, name: "No slowing down now, c'mon!", createdAt: '2024-01-01' },
      { id: 'ashley_8', url: 'https://actions.google.com/sounds/v1/human_voices/female_voice_short_phrase_08.ogg', vibeTag: 'calm', duration: 7, name: "Breathe. One step at a time.", createdAt: '2024-01-01' },
    ],
  },
  pacer_kevin: {
    pacerUserId: 'pacer_kevin',
    pacerName: 'Kevin',
    memos: [
      { id: 'kevin_1', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_01.ogg', vibeTag: 'fired_up', duration: 6, name: "LETS GOOO! You're a machine!", createdAt: '2024-01-01' },
      { id: 'kevin_2', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_02.ogg', vibeTag: 'fired_up', duration: 5, name: "Feel that fire? Use it!", createdAt: '2024-01-01' },
      { id: 'kevin_3', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_03.ogg', vibeTag: 'fired_up', duration: 7, name: "You trained for this!", createdAt: '2024-01-01' },
      { id: 'kevin_4', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_04.ogg', vibeTag: 'angry', duration: 6, name: "You think this is hard? PROVE IT!", createdAt: '2024-01-01' },
      { id: 'kevin_5', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_05.ogg', vibeTag: 'angry', duration: 5, name: "Pain is temporary. MOVE!", createdAt: '2024-01-01' },
      { id: 'kevin_6', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_06.ogg', vibeTag: 'harsh_coach', duration: 7, name: "Dig deeper. You have more.", createdAt: '2024-01-01' },
      { id: 'kevin_7', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_07.ogg', vibeTag: 'cheerful', duration: 5, name: "Looking strong out there!", createdAt: '2024-01-01' },
    ],
  },
  pacer_nick: {
    pacerUserId: 'pacer_nick',
    pacerName: 'Nick',
    memos: [
      { id: 'nick_1', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_08.ogg', vibeTag: 'calm', duration: 8, name: "Stay steady. Trust your training.", createdAt: '2024-01-01' },
      { id: 'nick_2', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_09.ogg', vibeTag: 'calm', duration: 6, name: "Find your rhythm.", createdAt: '2024-01-01' },
      { id: 'nick_3', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_10.ogg', vibeTag: 'calm', duration: 7, name: "Relax your shoulders. You're doing great.", createdAt: '2024-01-01' },
      { id: 'nick_4', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_11.ogg', vibeTag: 'cheerful', duration: 5, name: "Every step is progress!", createdAt: '2024-01-01' },
      { id: 'nick_5', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_12.ogg', vibeTag: 'harsh_coach', duration: 6, name: "This is where champions are made.", createdAt: '2024-01-01' },
      { id: 'nick_6', url: 'https://actions.google.com/sounds/v1/human_voices/male_voice_short_phrase_13.ogg', vibeTag: 'fired_up', duration: 5, name: "Finish line is waiting for you!", createdAt: '2024-01-01' },
    ],
  },
};
